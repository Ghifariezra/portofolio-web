        ...
        <div className="card-project" data-aos="fade-left">
            ...
            >
                <a href="/">
                    ...
                    { isHover && (<div className='hover-certif' style={{ backgroundImage: `url(${cert})` }}>
                    </div>)}
                </a>
            </div>
            <div className="wrapper-content-card">
                <div className='wrapper-source'>
                    ...
                    <div onMouseEnter={() => setIsHover(true)} onMouseLeave={() => setIsHover(false)} style={{ backgroundImage: `url(${CERTIFICATE})` }} className='trigger-certif' data-aos="fade-left">
                    </div>
                </div>
